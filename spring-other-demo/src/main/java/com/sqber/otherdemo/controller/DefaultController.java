package com.sqber.otherdemo.controller;
...
import com.sqber.otherdemo.dao.UserRepository;
import com.sqber.otherdemo.model.SaleModel;
import com.sqber.commonWeb.R;
import com.sqber.otherdemo.myenum.CheckInfoSyncState;
...
public class DefaultController {
    ...
    public DefaultController(JdbcTemplate jdbcTemplate, UserRepository userRepository) {
    ...
    @GetMapping("/")
    public String index() {
        return "spring-other-demo";
    }

    @GetMapping("/test")
    public R test() {
//        List<Map<String, Object>> list = jdbcTemplate.queryForList("select * from user");
        List<Map<String, Object>> list = userRepository.get();
